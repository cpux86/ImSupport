        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorksList = table.Column<string>(type: "TEXT", nullable: true),
                    DeviceId = table.Column<int>(type: "INTEGER", nullable: true),
                    ClientOfficeId = table.Column<int>(type: "INTEGER", nullable: false),
                    Master = table.Column<string>(type: "TEXT", nullable: false),
                    Client = table.Column<string>(type: "TEXT", nullable: false),
                    CaseManager = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Devices_Departments_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Office_Companys_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Office_Departments_DepartmentId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Cases_Departments_ClientOfficeId",
                table: "Cases",
                column: "ClientOfficeId",
                principalTable: "Departments",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Cases_Departments_ServiceId",
                table: "Cases",
                column: "ServiceId",
                principalTable: "Departments",
                principalColumn: "Id",
